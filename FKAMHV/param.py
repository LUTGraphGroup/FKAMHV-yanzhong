...
def parameter_parser():
    ...
    parser.add_argument('--data_path', type=str, default='./HMDD/MDAv3.0',
    ...
    parser.add_argument('--mi_num', type=int, default=788,
                        help='the number of miRANs.')
    parser.add_argument('--dis_num', type=int, default=374,
